...
def newMain():
    ...
    # rules = open(options["inputfile"]).read()

    outputFile = moleculizer.MoleculizerRulesFile()
    outputFile.outputFileName = options["outputfile"]
    
    outputFile.addWholeRulesFile(options["inputfile"])
